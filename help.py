...
{TIP} {M}Stay With Hayat — Stay safe, stay ethical.{RS}
''')
    pause()
...
def main():
    ...
    while True:
        ...
        if choice == '0':
            clear()
            print(f'\n{M}  ★ Stay With Hayat — Thanks for using WiFuX!{RS}\n')
            sys.exit(0)
